...
class EvidencesControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post evidences_url, params: { evidence: { description: @evidence.description, distributor: @evidence.distributor, order: @evidence.order, status: @evidence.status, title: @evidence.title } }
  #   end
  ...
  #   patch evidence_url(@evidence), params: { evidence: { description: @evidence.description, distributor: @evidence.distributor, order: @evidence.order, status: @evidence.status, title: @evidence.title } }
